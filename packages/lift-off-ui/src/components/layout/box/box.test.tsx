...
describe('Box', () => {
  it('renders the component', () => {
    ...
    expect(container).toContainHTML(
      '<div class="relative scrollbar-hidden">Hello World!</div>'
    );
  });
  ...
  describe('as prop', () => {
    it.each([
      ...
      // Assert
      expect(container).toContainHTML(
        `<${tag} class="absolute scrollbar-hidden">Hello World!</${tag}>`
      );
    });
  });
  ...
  describe('display prop', () => {
    it.each([
      ...
      ({
        ...
        // Assert
        expect(container).toContainHTML(
          `<div class="${className} relative scrollbar-hidden">Hello World!</div>`
        );
      }
    );
  });
