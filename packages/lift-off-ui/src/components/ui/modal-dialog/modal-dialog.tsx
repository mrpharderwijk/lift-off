...
import { useDialogContext } from '@/components/ui/modal-dialog/providers/dialog-context-provider';
      ...
      {!!isVisible && (
        ...
        >
          ...
          >
            ...
            <div className="flex shrink grow basis-2/3 flex-col overflow-auto">
              {!!header && (
                <ModalHeader>
...
export function ModalFocusTrapWithWrapper({
  ...
  return (
    <div
      className="flex shrink grow basis-2/3 flex-col gap-6 overflow-auto"
      ref={wrapRef}
    >
      {children}
    </div>
