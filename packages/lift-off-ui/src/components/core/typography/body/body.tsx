...
import { bodyClassNames } from './body.class-names';
...
type BodyProps = PropsWithChildren<
  PropsWithTestId<
    VariantProps<typeof bodyClassNames> & {
      ...
      'font-weight'?: VariantProps<typeof textClassNames>['font-weight'];
      'font-weight-sm'?: VariantProps<typeof textClassNames>['font-weight-sm'];
      'font-weight-md'?: VariantProps<typeof textClassNames>['font-weight-md'];
      'font-weight-lg'?: VariantProps<typeof textClassNames>['font-weight-lg'];
      'font-weight-xl'?: VariantProps<typeof textClassNames>['font-weight-xl'];
      tag?: TextElementTag;
    }
  >
>;
